...
//学习记录
-(void)setCourseRecoderModel:(JUCourseRecoderModel *)courseRecoderModel
{
    _courseRecoderModel = courseRecoderModel;
    /**
     *  //
     //course_id = 18,
...
//    NSURL *url = [NSURL URLWithString:courseRecoderModel.image_name];
//    [self.imv sd_setImageWithURL:url placeholderImage:[UIImage imageNamed:@"smallloading"]];
//  
//    
//    
//    
//    self.QQLabel.text = courseRecoderModel.course_title;
//    self.lessonLabel.text = courseRecoderModel.last_video.video_name;
//    NSString *str=courseRecoderModel.last_time;//时间戳
...
//  
//    
//    NSString *videoTime = [self studyTime:[courseRecoderModel.last_video.video_time integerValue]];
