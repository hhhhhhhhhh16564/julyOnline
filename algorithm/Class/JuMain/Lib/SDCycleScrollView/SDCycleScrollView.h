...
typedef enum {
    SDCycleScrollViewScrollUnKnow,
    SDCycleScrollViewScrollLeft,        //左边
    SDCycleScrollViewScrollRight        //右边
  
} SDCycleScrollViewScrollDirection;
...
#pragma mark 自己添加的拓展
@property (nonatomic,assign)  SDCycleScrollViewScrollDirection scrollViewDirection;
